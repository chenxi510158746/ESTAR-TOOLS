...
//应用市场部分
UIKIT_EXTERN NSString *const ARMarketTitle;
UIKIT_EXTERN NSString *const DownloadInstall;
UIKIT_EXTERN NSString *const Uninstall;
UIKIT_EXTERN NSString *const Cancel;

UIKIT_EXTERN NSString *const UnConnectGlass;
UIKIT_EXTERN NSString *const Back;
UIKIT_EXTERN NSString *const SendDownLoadInfo;
UIKIT_EXTERN NSString *const SendUninstall;
UIKIT_EXTERN NSString *const NetworkError;



UIKIT_EXTERN NSString *const DevicesLinkError;
UIKIT_EXTERN NSString *const WifiName;
UIKIT_EXTERN NSString *const WifiPwd;
UIKIT_EXTERN NSString *const APName;

UIKIT_EXTERN NSString *const APPwd;
UIKIT_EXTERN NSString *const Send;
UIKIT_EXTERN NSString *const NetworkSetting;
UIKIT_EXTERN NSString *const NetworkSuccessTips;
UIKIT_EXTERN NSString *const NetworkFailTips;

UIKIT_EXTERN NSString *const StartWifi;
UIKIT_EXTERN NSString *const NetworkSettingNetworkTips;
UIKIT_EXTERN NSString *const StartAp;
UIKIT_EXTERN NSString *const NetworkSuccessTips;
UIKIT_EXTERN NSString *const NetworkSettingApTips;

UIKIT_EXTERN NSString *const StartAPorWIFI;
UIKIT_EXTERN NSString *const DownloadIntsallFail;
